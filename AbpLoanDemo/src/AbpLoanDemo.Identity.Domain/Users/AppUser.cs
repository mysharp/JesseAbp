...
namespace AbpLoanDemo.Identity.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update IdentityDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update IdentityEfCoreEntityExtensionMappings to extend the IdentityUser entity
